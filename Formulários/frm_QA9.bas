VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frm_QA9 
   Caption         =   "                                                                           Questão alternativa 9 - Ciência da computação ENADE 2014"
   ClientHeight    =   10515
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   12015
   OleObjectBlob   =   "frm_QA9.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frm_QA9"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False

Private Sub cmd_fecharQA9_Click()
...
Private Sub cmd_finalizarQA9_Click()
...
Private Sub cmd_proxQA10_Click()
...
Private Sub opt_altAQA9_Click()
    'A opção A armazenará a letra na variárial
    Q(9) = "A"
End Sub

Private Sub opt_altBQA9_Click()
    'A opção B armazenará a letra na variárial
    Q(9) = "B"
End Sub

Private Sub opt_altCQA9_Click()
    'A opção B armazenará a letra na variárial
    Q(9) = "C"
End Sub

Private Sub opt_altDQA9_Click()
    'A opção D armazenará a letra na variárial
    Q(9) = "D"
End Sub

Private Sub opt_altEQA9_Click()
...
i = 9
        ...
        opt_altAQA9.Enabled = False
        opt_altBQA9.Enabled = False
        opt_altCQA9.Enabled = False
        opt_altDQA9.Enabled = False
        opt_altEQA9.Enabled = False
        cmd_proxQA10.Enabled = False
        cmd_finalizarQA9.Enabled = False
        
        'A resposta será registrada na planilha
        ThisWorkbook.Worksheets("Respostas").Cells(linha, 16).Value = Q(i)
...
With Me
    ...
    .ScrollHeight = .InsideHeight * 1.33
End With
